...
//#region node_modules/react-ga4/dist/gtag.js
var require_gtag = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports["default"] = void 0;
	exports["default"] = function gtag() {
...
//#endregion
//#region node_modules/react-ga4/dist/format.js
...
//#endregion
//#region node_modules/react-ga4/dist/ga4.js
var require_ga4 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var _excluded = [
		...
		"eventValue",
		"hitType"
	], _excluded2 = ["title", "location"], _excluded3 = ["page", "hitType"];
	...
	var GA4 = /* @__PURE__ */ function() {
		function GA4() {
			...
			_defineProperty(this, "_gtag", function() {
				for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
				if (!_this._testMode) if (_this._isQueuing) _this._queueGtag.push(args);
			...
			_defineProperty(this, "_toGtagOptions", function(gaOptions) {
				...
				return Object.entries(gaOptions).reduce(function(prev, _ref) {
			...
			_defineProperty(this, "initialize", function(GA_MEASUREMENT_ID) {
				...
				var initConfigs = typeof GA_MEASUREMENT_ID === "string" ? [{ trackingId: GA_MEASUREMENT_ID }] : GA_MEASUREMENT_ID;
			...
			_defineProperty(this, "_gaCommandSendEvent", function(eventCategory, eventAction, eventLabel, eventValue, fieldsObject) {
				_this._gtag("event", eventAction, _objectSpread(_objectSpread({
					...
					value: eventValue
				}, fieldsObject && { non_interaction: fieldsObject.nonInteraction }), _this._toGtagOptions(fieldsObject)));
			});
			...
			_defineProperty(this, "_gaCommandSendPageview", function(page, fieldsObject) {
				if (fieldsObject && Object.keys(fieldsObject).length) {
					...
					_this._gtag("event", "page_view", _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, page && { page_path: page }), title && { page_title: title }), location && { page_location: location }), rest));
				} else if (page) _this._gtag("event", "page_view", { page_path: page });
			...
			_defineProperty(this, "_gaCommandSend", function() {
				...
				switch (hitType) {
					...
					case "exception":
						...
						break;
					default: console.warn("Send command doesn't exist: ".concat(hitType));
				}
			});
			...
			_defineProperty(this, "_gaCommand", function(command) {
				...
				switch (command) {
					...
					case "set":
						...
						break;
					default: console.warn("Command doesn't exist: ".concat(command));
				}
			});
			_defineProperty(this, "ga", function() {
				...
				if (typeof args[0] === "string") _this._gaCommand.apply(_this, args);
					...
					_this._gtag("get", _this._currentMeasurementId, "client_id", function(clientId) {
						...
						readyCallback({ get: function get(property) {
...
//#endregion
//#region node_modules/react-ga4/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.ReactGAImplementation = _ga.GA4;
	exports["default"] = _ga["default"];
}));
//#endregion
