      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative w-32 h-32">
          <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
            <circle cx="18" cy="18" fill="transparent" r="16" stroke="#e9edff" strokeWidth="4"></circle>
            <circle
        ...
        <ul className="space-y-3 flex-1">
          <li className="flex justify-between items-center text-sm">
            ...
            <span className="font-bold">{format(breakdown.tuition)}</span>
          </li>
          <li className="flex justify-between items-center text-sm">
            <span className="flex items-center gap-2">
            ...
            <span className="font-bold">{format(breakdown.living)}</span>
          </li>
          <li className="flex justify-between items-center text-sm">
            <span className="flex items-center gap-2">
            ...
            <span className="font-bold">{format(breakdown.misc)}</span>
          </li>
        </ul>
      </div>
    </div>
