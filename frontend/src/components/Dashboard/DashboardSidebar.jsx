...
const DashboardSidebar = () => {
  return (
    <div className="lg:col-span-4 space-y-8">
      <section className="bg-primary bg-gradient-to-br from-primary to-primary-container rounded-xl p-8 text-on-primary shadow-xl">
        <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
          <span className="material-symbols-outlined">bolt</span>
          Recommended Actions
        </h2>
        <div className="space-y-4">
          <Link className="block bg-on-primary/10 hover:bg-on-primary/20 p-4 rounded-lg transition-colors group" to="/applications">
            ...
            <p className="text-xs text-on-primary/60 opacity-80 mt-1">Connect your verified student ID to finalize your refinance rate.</p>
          </Link>
          ...
          <button className="w-full flex items-center gap-3 p-4 bg-on-primary/5 hover:bg-on-primary/10 rounded-lg transition-colors text-left" type="button">
            ...
            <div className="flex-grow">
              ...
              <div className="text-xs text-on-primary/60">3 new rates available today</div>
            </div>
          </button>
          <button className="w-full flex items-center gap-3 p-4 bg-on-primary/5 hover:bg-on-primary/10 rounded-lg transition-colors text-left" type="button">
            ...
            <div className="flex-grow">
              ...
              <div className="text-xs text-on-primary/60">Matched: STEM Women Grant</div>
            </div>
          </button>
        </div>
      </section>
