...
const LandingPage = () => {
  ...
  return (
    <div className="bg-surface text-on-surface selection:bg-secondary/30 selection:text-secondary min-h-screen font-['Inter']">
      <main>
        {/* Hero Section */}
        <section className="relative overflow-hidden pt-10 sm:pt-16 pb-16 sm:pb-24 md:pt-24 md:pb-32 bg-surface">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 items-center gap-10 md:gap-16">
            <div className="z-10 order-2 md:order-1">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-on-surface leading-[0.95] tracking-tight mb-6 md:mb-8">
              ...
              <p className="text-base sm:text-xl text-on-surface-variant leading-relaxed mb-8 md:mb-10 max-w-xl font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <button
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-10 py-3.5 sm:py-4 bg-primary text-on-primary font-bold rounded-lg tracking-wide hover:shadow-xl active:scale-95 transition-all uppercase text-sm sm:text-base"
                >
                  CALCULATE YOUR TRUE COST
                </button>
                <button
                  onClick={scrollToFeatures}
                  className="inline-flex items-center justify-center px-6 sm:px-10 py-3.5 sm:py-4 bg-surface-container text-on-surface font-bold rounded-lg tracking-wide hover:bg-surface-container-high active:scale-95 transition-all uppercase text-sm sm:text-base"
                >
                  LEARN MORE
                </button>
              </div>
        ...
        {/* Features Bento Grid */}
        <section ref={featuresRef} className="py-16 md:py-24 bg-surface-container-low">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
              <div className="max-w-2xl">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-on-surface tracking-tighter mb-4 leading-tight">Architectural Solutions for Financial Stability</h2>
        ...
        <section className="py-16 md:py-24 bg-surface">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="w-full md:w-3/5 bg-surface-container-high p-6 sm:p-10 rounded-2xl relative overflow-hidden border border-outline-variant/10">
            ...
            <div className="w-full md:w-2/5">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-on-surface leading-tight mb-6">Stop guessing. Start calculating.</h2>
